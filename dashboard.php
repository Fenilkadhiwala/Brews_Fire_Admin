    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                $totalOrdersQ = "SELECT COUNT(*) as count FROM `history`";

                $tRes = mysqli_query($conCust, $totalOrdersQ);
                if ($tRes->num_rows > 0) {
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-danger navbar-badge"><?php echo $totalOrders; ?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item">
                            <i class="fas fa-users mr-2"></i> 8 cancellations
                            <span class="float-right text-muted text-sm">12 hours</span>
                        </a>

                        <div class="dropdown-divider"></div>
                        <a href="newOrders.php" class="dropdown-item dropdown-footer">See All Notifications</a>
                    </div>
                </li>
                <li class="nav-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="rawMaterial.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="godown.php" class="nav-link">
