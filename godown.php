        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Godown Details</h1>
                        </div><!-- /.col -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="insertRawMaterial.php" enctype="multipart/form-data"
                                    autocomplete="off">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="rawMaterialName">Raw Material Name</label>
                                            <input name="rawMaterialName" type="text" class="form-control"
                                                id="rawMaterialName" placeholder="Enter Raw Material Name" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="price" type="number" class="form-control" id="quantity"
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <select name="auctionType" class="form-control" id="auctionType" required>
                                        ...
                                        <div class="form-group">
                                            <label for="quantity">Logistic Expense</label>
                                            <input name="logistic" type="text" class="form-control" id="quantity"
                                                placeholder="Enter Logistic Expense" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="quantity">GST Amount</label>
                                            <input name="gst" type="text" class="form-control" id="quantity"
                                                placeholder="Enter GST Amount" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="quantity">Final Amount</label>
                                            <input name="final" type="text" class="form-control" id="quantity"
                                                placeholder="Enter Final Amount" required>
                                        </div>
